...
function Register() {
  return (
    <>
      {/* Login */}
      <div className="mt-12">
        <div className=" grid grid-cols-2 mx-auto px-8 py-8">
          ...
          {/* <form>
            <div className="flex justify-center align-items-center">
              ...
              <div>
                <input
                  className="flex-grow p-2 border border-blue-400 rounded-md mb-4"
                  placeholder="example@mail.com"
                  required
                ></input>
                <input
                  className="flex flex-grow p-2 border border-blue-400 rounded-md mb-4"
          ...
          <form class="form_container">
            ...
            <div class="input_container">
              <label class="input_label" for="firstname_field">
                First Name
              </label>
              <svg
                fill="none"
            ...
            <div class="input_container">
              <label class="input_label" for="lastname_field">
                Last Name
              </label>
              <svg
                fill="none"
            ...
            <a href="login">Don't have an account? Log In here</a>
            ...
            <p class="note">
              <a href="terms-and-conditions">Terms of use &amp; Conditions</a>
            </p>
          </form>
          {/* <img className="" src={Outside}></img> */}
          <div className="text-center ">Light up the atmosphere</div>
        </div>
      </div>
    </>
  );
